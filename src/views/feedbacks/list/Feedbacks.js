  ...
  const columns = [
    {
      ...
      render: (text, record) => (
        <NavLink to="/support/detail">{record.userId}</NavLink>
      ),
    },
    {
      ...
      render: (text, record) => (
        <div className="d-flex">
          <div className="round-image">
            <img style={smallImageStyle} src={record.userImage} alt={record.userName} />
          </div>
          <div>
            <div className="ms-2">{record.userName}</div>
    ...
    {
      title: <span style={tableHeaderStyle}>CONTENT</span>,
      dataIndex: 'feedback',
      key: 'feedback',
      responsive: ['xs', 'md', 'lg', 'sm', 'xl'],
    ...
    {
      title:<span style={tableHeaderStyle}>RATINGS</span> ,
