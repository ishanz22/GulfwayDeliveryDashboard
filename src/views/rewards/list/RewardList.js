      ...
      <>
        ...
        <Row className="g-0 h-100 align-content-center d-none d-lg-flex ps-5 pe-5 mb-2 custom-sort">
          ...
          <Col md="2" className="d-flex flex-column pe-1 justify-content-center">
            <div className="text-muted text-small cursor-pointer sort">TRANSACTION DATE</div>
          </Col>
          <Col md="1" className="d-flex flex-column pe-1 justify-content-center">
              ...
              <Row className="g-0 h-100 align-content-center cursor-default" onClick={() => checkItem(item.id)}>
                ...
                <Col xs="3" md="1" className="d-flex flex-column justify-content-center mb-2 mb-md-0 order-4 order-md-3">
                  ...
                  <div className="text-truncate">
                    <div className="text-truncate h-100 d-flex align-items-center">{item.id}</div>
                  </div>
                </Col>
                ...
                <Col xs="6" md="2" className="d-flex flex-column justify-content-center mb-2 mb-md-0 order-5 order-md-4">
                  <div className="text-muted text-small d-md-none">Transaction date</div>
                  <div className="text-alternate">{item.transactionDate}</div>
                </Col>
                ...
                <Col xs="3" md="1" className="d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
                  ...
                  <div>
                    <div className="text-alternate">AED {item.transactionAmount}</div>
                  </div>
                </Col>
                <Col xs="3" md="1" className="d-flex flex-column justify-content-center mb-2 mb-md-0 order-last order-md-5">
