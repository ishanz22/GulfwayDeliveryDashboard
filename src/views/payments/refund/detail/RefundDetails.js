...
import ApprovedLabel from 'components/Labels/ApprovedLabel';
    ...
    <>
      ...
      <div className="page-title-container">
        <Row className="g-0">
          ...
          <Col className="col-auto mb-3 mb-sm-0 me-auto">
            <NavLink className="muted-link pb-1 d-inline-block hidden breadcrumb-back" to="/payments/refund">
              <CsLineIcons icon="chevron-left" size="13" />
              <span className="align-middle text-small ms-1">Refund Orders</span>
            </NavLink>
      ...
      <Row>
        ...
        <Col xl="4" xxl="3">
          ...
          <h5 className="me-3">Refund Summary</h5>
          <Card className="mb-0">
            <Card.Body>
              ...
              <div className="mb-n0 p-2 d-flex justify-content-between">
                <div style={{ fontWeight: '700' }}>Refund Date</div>
                <div>Sat, Sep 9 2023</div>
              </div>
              <div className="mb-0 p-2 d-flex justify-content-between">
  <div style={{ fontWeight: '700' }}>Status</div>
  <div>
  <ApprovedLabel>APPROVED</ApprovedLabel>
