...
const Nav = () => {
  ...
  return (
    <div id="nav" style={{borderRadius:"0px"}} className={classNames('nav-container d-flex', navClasses)} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      <div
        className="nav-content d-flex"
        style={{
          // backgroundColor: '#7a7a7a', // nav background
