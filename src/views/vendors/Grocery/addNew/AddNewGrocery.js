...
const AddNewSupermarket = ({ google }) => {
  ...
  return (
    <>
      ...
      <Row className="row-cols-1 row-cols-md-2 g-2">
          ...
          <Card className=" h-100">
            <Card.Body>
              <Form className="mb-n3">
                <div className="mb-3">
                  <Form.Label>SuperMarket Name</Form.Label>
                  <Form.Control type="text" defaultValue="My Awesome Corp." />
                </div>
                <div className="mb-3">
                  <Form.Label>SuperMarket Address</Form.Label>
        ...
        <Col>
          <h2 className="small-title">SuperMarket Logo & Covers</h2>
          <Card className=" h-100">
            <Card.Body>
              <Row>
                <Col className="col-auto mb-3 mb-sm-0 me-auto">
      ...
      <div style={{ paddingTop: '60px' }}>
        <h2 className="small-title">SuperMarket Info</h2>
        <Card className="mb-5">
          <Card.Body>
            <Form>
              <Row className="g-3">
